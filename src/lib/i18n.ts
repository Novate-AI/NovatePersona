...
const translations: Record<UILocale, Record<string, string>> = {
  en: {
    ...
    'tutor.welcomeHeading': 'Chat with Abby',
    'tutor.practiceLine': 'Practice {lang} · {level}',
    'tutor.settingsHint': 'Change language or CEFR level in the bar above anytime.',
    'tutor.abbyLayoutSplit': 'Show Abby panel (split view)',
    'tutor.abbyLayoutFocus': 'Abby on top only (focus chat)',
    'tutor.coldWelcome': 'Choose a quick topic or tap Begin lesson for Abby\'s greeting. Then keep typing or use the mic — she adapts to your CEFR level.',
    'tutor.beginLesson': 'Begin lesson',
    'tutor.errorRateLimit': 'Too many requests. Wait a moment and try again.',
    'tutor.errorCredits': 'No session credits left. Upgrade your plan to continue.',
    'tutor.errorConnect': 'Could not reach the server. Check your connection and try again.',
